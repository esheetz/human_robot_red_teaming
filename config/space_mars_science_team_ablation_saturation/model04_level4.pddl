(define (domain space_mars_science_team)
  ...
  (:action set_temperature_level
    :parameters (?l - level)
    :precondition (temperature_normal) ;; Only update if current condition is normal
  ...
  ;; Invalidation actions for each underlying condition (as in previous versions)
  ...
  ;;--------------------------------------------------
  ;; Ground Control Status Update Action
  ...
  ;;--------------------------------------------------
  ;; Detailed Environmental Condition Updates (existing actions remain)
  ...
  ;;--------------------------------------------------
  ;; Communication Blackout and Backup Protocols (as before)
  ...
  ;;--------------------------------------------------
  ;; Logging and Ground Control Verification Actions (updated preconditions)
